      ...
      <section className="rounded-2xl border border-stone-200 bg-white p-3 shadow-sm">
        ...
        {moreFiltersOpen && (
          <div className="mt-3 grid gap-2 rounded-xl border border-stone-200 bg-stone-50 p-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            ...
            <Select label="Issue" value={inventoryIssueFilter} onChange={(event) => onSetInventoryIssueFilter(event.target.value)}><option>All items</option><option>Needs Attention</option><option>Needs Purchase Details</option><option>Missing Proof</option><option>Needs Listing Preparation</option><option>Ready for Listing</option><option>Review later</option><option>Sold only</option><option>Unsold only</option></Select>
