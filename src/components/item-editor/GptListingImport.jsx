          ...
          <div className="max-h-[92vh] w-full max-w-6xl overflow-auto rounded-3xl border border-stone-200 bg-[#fffdf8] p-4 shadow-2xl sm:p-5">
            ...
            {stage === "review" && validationResult?.ok && (
              <div className="mt-4 space-y-4">
                <p className="rounded-xl border border-orange-200 bg-orange-50 p-3 text-sm font-medium text-orange-950">Final plain and HTML descriptions will be generated by the ResellIt template.</p>
